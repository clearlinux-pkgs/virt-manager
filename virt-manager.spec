...
#
# Source0 file verified with key 0x64559E28C21CC7A8 (cole.j.robinson@gmail.com)
#
Name     : virt-manager
Version  : 4.1.0
Release  : 40
...
%prep
%setup -q -n virt-manager-4.1.0
cd %{_builddir}/virt-manager-4.1.0
%patch -P 1 -p1
pushd ..
cp -a virt-manager-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695938345
