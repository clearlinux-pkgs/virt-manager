...
#
# Source0 file verified with key 0x522D64733007E18C (phrdina@redhat.com)
#
Name     : virt-manager
Version  : 5.0.0
Release  : 43
URL      : https://releases.pagure.org/virt-manager/virt-manager-5.0.0.tar.xz
Source0  : https://releases.pagure.org/virt-manager/virt-manager-5.0.0.tar.xz
Source1  : https://releases.pagure.org/virt-manager/virt-manager-5.0.0.tar.xz.asc
Source2  : 522D64733007E18C.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 522D64733007E18C' gpg.status
%setup -q -n virt-manager-5.0.0
cd %{_builddir}/virt-manager-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747263358
...
cp %{_builddir}/virt-manager-%{version}/COPYING %{buildroot}/usr/share/package-licenses/virt-manager/4cc77b90af91e615a64ae04893fdffa7939db84c || :
GOAMD64=v2
...
/usr/share/virt-manager/virtinst/_progresspriv.py
/usr/share/virt-manager/virtinst/build.cfg
...
/usr/share/virt-manager/virtinst/devices/audio.py
...
/usr/share/virt-manager/virtinst/devices/iommu.py
...
/usr/share/virt-manager/virtinst/devices/shmem.py
...
/usr/share/virt-manager/virtinst/domain/keywrap.py
...
/usr/share/virt-manager/virtinst/install/cloudinit.py
...
/usr/share/virt-manager/virtinst/install/volumeupload.py
...
/usr/share/virt-manager/virtinst/virtclone.py
/usr/share/virt-manager/virtinst/virtinstall.py
/usr/share/virt-manager/virtinst/virtxml.py
...
/usr/share/package-licenses/virt-manager/4cc77b90af91e615a64ae04893fdffa7939db84c
