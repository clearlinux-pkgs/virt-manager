...
Source0  : https://virt-manager.org/download/sources/virt-manager/virt-manager-4.0.0.tar.gz
...
%prep
%setup -q -n virt-manager-4.0.0
cd %{_builddir}/virt-manager-4.0.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648827404
...
cp %{_builddir}/virt-manager-4.0.0/COPYING %{buildroot}/usr/share/package-licenses/virt-manager/4cc77b90af91e615a64ae04893fdffa7939db84c
