...
%prep
%setup -q -n virt-manager-3.2.0
cd %{_builddir}/virt-manager-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621272704
...
cp %{_builddir}/virt-manager-3.2.0/COPYING %{buildroot}/usr/share/package-licenses/virt-manager/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
